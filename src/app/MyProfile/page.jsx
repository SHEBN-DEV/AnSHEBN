            ...
            <div className="md:w-full">
                ...
                <div className="md:relative flex items-start bottom-9 left-0">
                    <div className="w-1/2 flex items-center pl-4">
                        ...
                        <div>
                            <p className="text-3xl font-bold">Maria Torre</p>
                            <p className="text-sm">mariatorre5</p>
                        </div>
                    </div>
                ...
                <div className="flex flex-col gap-10 p-4 md:py-10">
                    <div className="">
                        ...
                        <p className="text-base">{content.experience}</p>
                    </div>
                    ...
                    <div className="flex items-start justify-between">
                        ...
                        <div className="w-2/5 flex flex-col gap-2">
                            ...
                            <a href="" className="text-base hover:text-[#ff29d7]"></a>
                        </div>
                    </div>
                </div>
